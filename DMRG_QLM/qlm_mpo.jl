...
function promtocompl(u)
    u=convert(Array{Complex{Float64},2},u)
end

function mpoqlm_with_interaction_chemical_potential_and_magneti_field(N::Int;   coupling=-1. , mu=-1 , theta= 1.)
    sp = [0. 1.; 0. 0.]
    sm = [0. 0.; 1. 0.]
    sz = [1. 0.; 0. -1.]
    u = [1. 0.; 0. 1.]
